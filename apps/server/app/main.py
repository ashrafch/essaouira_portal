...
def _is_auto_booking_transition_task(task: StaffTask) -> bool:
...
def _merge_notes_for_auto_task(existing_notes: str | None, incoming_notes: str | None) -> str | None:
...
def update_staff_task(
    ...
    was_auto_task = _is_auto_booking_transition_task(task)
    ...
    if was_auto_task:
        task.notes = _merge_notes_for_auto_task(old_notes, payload.notes)
    else:
