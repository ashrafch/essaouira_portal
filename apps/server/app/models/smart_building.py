...
class Device(TenantScopedMixin, Base):
    ...
    connectivity_status = Column(String(16), nullable=False, default="unknown")
...
class AutomationExecution(TenantScopedMixin, Base):
    ...
    trigger_source = Column(String(64), nullable=False, default="manual.api")
    trigger_snapshot_json = Column(Text, nullable=True)
